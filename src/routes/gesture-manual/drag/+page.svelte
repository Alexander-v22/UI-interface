...
<main class="flex-1 max-w-6xl mx-auto px justify-center">
  ...
  <h1 class="text-5xl py-5 text-center">Hand Gesture Drag Demo</h1>
  ...
  <p class="text-lg mt-5">
    ...
    <section>
        <img src="/video-demos/DragDemo.gif" alt="Curser And Button" class="mt-10 rounded-xl shadow-lg w-[400px] mx-auto" />
    </section>

  <div class="flex flex-rows-2 px-10">
    <div>
      <h2 class="py-2 text-2xl mt-4">Using Your Hand to Drag</h2>
    ...
    <div>
        <h2 class="py-2 text-2xl mt-4">Grabbing with a Gesture</h2>
        <p class="text-lg px-4">
